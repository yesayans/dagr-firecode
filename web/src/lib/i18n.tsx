...
const dict = {
  en: {
    ...
    reviewsCsvHint: "Auto-detects columns like review/text/body, rating/stars, date. Reviews under 10 words and duplicates are dropped; every rating is kept. Without a rating column, severity and spread are omitted from confidence.",
  ...
  ru: {
    ...
    reviewsCsvHint: "Автоопределение колонок review/text/body, rating/stars, date. Отбрасываются отзывы короче 10 слов и дубликаты; все оценки сохраняются. Без колонки с оценкой severity и spread исключаются из confidence.",
